...
The purpose of this project is to develop a Library Management System (LMS) that simplifies book access for patrons and streamlines administrative tasks for librarians. The system will provide tailored functionalities for both users and librarians, enhancing library operations and improving the user experience.
...
# Domain Model
![Domain Model](https://github.com/user-attachments/assets/bb5cd2cb-8866-42e7-a030-e616070ea816)
